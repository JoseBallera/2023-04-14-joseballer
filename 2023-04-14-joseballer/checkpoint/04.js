...
function construccionCasas(bolsas) {
  // Tu código aquí:
   ...
   return function casas(num) {
    if (num <= 0) return "Por favor ingresar cuantas casas quieres construir";
    if (bolsas/10 < 1) return "No se puede construir casas con esa cantidad de bolsas";
    if (num > bolsas/10) return "Solo puedes construir esta cantidad de casas: " + Math.floor(bolsas/10);  
    if (num === bolsas/10) return true;
   }
  }
